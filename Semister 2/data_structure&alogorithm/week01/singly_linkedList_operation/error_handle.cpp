...
int main(){
    ...
    while (true)
    {
        cout << "Option 1: Create node at tail" << endl; // error handle done
        cout << "Option 2: Print Linked List" << endl; // error handle done
        cout << "Option 3: Insert Node at position" << endl; // error handle done
        cout << "Option 4: Insert Node at head" << endl; // error handle done
        cout << "Option 5: Delete node at position" << endl; // error handle done
        cout << "Option 6: Delete head node" << endl; // error handle done
